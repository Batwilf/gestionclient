...
use GC\FactureBundle\Entity\Facture;
...
class FactureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $factures = $em->getRepository('GCFactureBundle:Facture')->findAll();
    ...
    {
        $facture = new Facture();
        $form = $this->createForm('GC\FactureBundle\Form\FactureType', $facture);
    ...
    {
        $deleteForm = $this->createDeleteForm($facture);
        $editForm = $this->createForm('GC\FactureBundle\Form\FactureType', $facture);
